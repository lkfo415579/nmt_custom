...
def run_sample_decode(infer_model, infer_sess, model_dir, hparams,
  ...
  with infer_model.graph.as_default():
    loaded_infer_model, global_step = model_helper.create_or_load_model(
        infer_model.model, model_dir, infer_sess, "infer", infer_model.insert_op)
...
def run_internal_eval(
  ...
  with eval_model.graph.as_default():
    loaded_eval_model, global_step = model_helper.create_or_load_model(
        eval_model.model, model_dir, eval_sess, "eval", eval_model.insert_op)
...
def train(hparams, scope=None, target_session=""):
  ...
  with train_model.graph.as_default():
    loaded_train_model, global_step = model_helper.create_or_load_model(
        train_model.model, model_dir, train_sess, "train", train_model.insert_op)
